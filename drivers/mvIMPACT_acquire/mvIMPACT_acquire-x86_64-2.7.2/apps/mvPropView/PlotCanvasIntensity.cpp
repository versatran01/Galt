...
//-----------------------------------------------------------------------------
{
    ...
    for( unsigned int i = 0; i < m_PlotCount; i++ )
    {
        ...
        {
            m_CurrentMaxPlotValues[i] = *( std::max_element( m_ppPlotValues[i]->begin(), m_ppPlotValues[i]->end() ) );
        }
        ...
        {
            m_CurrentMinPlotValues[i] = *( std::min_element( m_ppPlotValues[i]->begin(), m_ppPlotValues[i]->end() ) );
        }
...
//-----------------------------------------------------------------------------
{
    ...
    for( std::vector<wxString>::size_type i = 0; i < psLAST; i++ )
    {
