...
DECLARE_EVENT_TYPE( imageReadyEvent, -1 )
DECLARE_EVENT_TYPE( imageSkippedEvent, -2 )
DECLARE_EVENT_TYPE( toggleDisplayArea, -3 )
DECLARE_EVENT_TYPE( liveModeAborted, -4 )
DECLARE_EVENT_TYPE( eventNotified, -5 )
DECLARE_EVENT_TYPE( sequenceReadyEvent, -6 )
DECLARE_EVENT_TYPE( imageInfoEvent, -7 )
DECLARE_EVENT_TYPE( refreshAOIControls, -8 )
DECLARE_EVENT_TYPE( refreshCurrentPixelData, -9 )
DECLARE_EVENT_TYPE( imageCanvasSelected, -10 )
DECLARE_EVENT_TYPE( imageCanvasFullScreen, -11 )
DECLARE_EVENT_TYPE( monitorImageClosed, -12 )
DECLARE_EVENT_TYPE( featureChangedCallbackReceived, -13 )
...
protected:
    ...
    void OnEventNotified( wxCommandEvent& e );
    ...
    void OnNBPropertyGridsPageChanged( wxNotebookEvent& e );
    ...
    {
        UpdateToolTipWindowAndWizardStatus( e.GetProperty() );
    }
...
private:
    ...
    //-----------------------------------------------------------------------------
    {
        ...
        miAction_DefaultDeviceInterface_Generic,
    ...
    DisplayWindowContainer              m_pDisplayAreas;
