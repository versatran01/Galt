...
//-----------------------------------------------------------------------------
{
    ...
    p->SetExtraStyle( wxPG_EX_MODE_BUTTONS );
    p->SetExtraStyle( wxPG_EX_HELP_AS_TOOLTIPS );
    //p->SetExtraStyle( wxPG_EX_GREY_LABEL_WHEN_DISABLED ); // this will display lists as disabled as well...
